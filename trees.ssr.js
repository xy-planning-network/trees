'use strict';var vue=require('vue');function _classCallCheck$1(instance, Constructor) {
...
var BaseAPI = {
  makeRequest: function makeRequest(config, opts) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      apiAxiosInstance(config).then(function (success) {
  ...
  get: function get(path, opts, params) {
  ...
  delete: function _delete(path, opts) {
    return this.makeRequest({
      url: path,
      method: "DELETE"
    }, opts);
...
var ActionsDropdown = (_dec$d = Options({
  components: {
  ...
  type: Object,
  required: true
}), _dec$d(_class$d = (_class2$b = /*#__PURE__*/function (_Vue) {
  ...
  function ActionsDropdown() {
    ...
    _classCallCheck$1(this, ActionsDropdown);
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "currentUser", _descriptor$b, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "items", _descriptor2$9, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "propsData", _descriptor3$7, _assertThisInitialized$1(_this));

    return _this;
  }

  _createClass$1(ActionsDropdown, [{
    key: "emitEvent",
...
}(Vue), (_descriptor$b = _applyDecoratedDescriptor(_class2$b.prototype, "currentUser", [_dec2$b], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2$b)) || _class$d);var _hoisted_1$c = /*#__PURE__*/vue.createVNode("span", {
  class: "sr-only"
}, "Open options", -1);
...
function render$j(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_MenuItem = vue.resolveComponent("MenuItem");

  var _component_MenuItems = vue.resolveComponent("MenuItems");

  var _component_Menu = vue.resolveComponent("Menu");
  ...
  return vue.openBlock(), vue.createBlock(_component_Menu, {
    ...
    default: vue.withCtx(function () {
      return [vue.createVNode(_component_MenuButton, {
        ...
        default: vue.withCtx(function () {
          return [_hoisted_1$c, vue.createVNode(_component_DotsVerticalIcon, {
            class: "w-5 h-5",
            "aria-hidden": "true"
          })];
        }),
        ...
        default: vue.withCtx(function () {
          return [vue.createVNode(_component_MenuItems, {
            ...
            default: vue.withCtx(function () {
              return [vue.createVNode("div", _hoisted_2$a, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.items, function (item, idx) {
                return vue.openBlock(), vue.createBlock(vue.Fragment, {
                  key: idx
                }, [_ctx.show(item) ? (vue.openBlock(), vue.createBlock(_component_MenuItem, {
                  key: 0,
                  as: "div"
                }, {
                  ...
                  _: 2
                }, 1024)) : vue.createCommentVNode("", true)], 64);
              }), 128))])];
            }),
            _: 1
          })];
...
}ActionsDropdown.render = render$j;const HOOKS = [
    "onChange",
    "onClose",
    "onDayCreate",
    "onDestroy",
...
const arrayify = (obj) => obj instanceof Array ? obj : [obj];function toggleClass(elem, className, bool) {
    if (bool === true)
...
styleInject(css_248z);var _dec$c, _dec2$a, _dec3$a, _dec4$9, _class$c, _class2$a, _descriptor$a, _descriptor2$8;
var DateRangePicker = (_dec$c = Options({
  ...
  type: Number,
  required: false
}), _dec4$9 = Emit("update:modelValue"), _dec$c(_class$c = (_class2$a = /*#__PURE__*/function (_Vue) {
  ...
  function DateRangePicker() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "modelValue", _descriptor$a, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "startDate", _descriptor2$8, _assertThisInitialized$1(_this));
  ...
  _createClass$1(DateRangePicker, [{
    ...
    value: function updateModelValue(value) {
      return value;
    }
  }, {
    key: "mounted",
...
}(Vue), (_descriptor$a = _applyDecoratedDescriptor(_class2$a.prototype, "modelValue", [_dec2$a], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2$a.prototype, "updateModelValue", [_dec4$9], Object.getOwnPropertyDescriptor(_class2$a.prototype, "updateModelValue"), _class2$a.prototype)), _class2$a)) || _class$c);var _hoisted_1$b = {
  type: "text",
  class: "shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md",
  placeholder: "mm-dd-yyyy range"
};
function render$i(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("input", _hoisted_1$b);
}DateRangePicker.render = render$i;var _dec$b, _dec2$9, _dec3$9, _dec4$8, _dec5$6, _dec6$4, _class$b, _class2$9, _descriptor$9, _descriptor2$7, _descriptor3$6;
var DateFilter = (_dec$b = Options({
  components: {
  ...
  type: String,
  required: true
}), _dec5$6 = Emit(), _dec6$4 = Emit(), _dec$b(_class$b = (_class2$9 = /*#__PURE__*/function (_Vue) {
  ...
  function DateFilter() {
    ...
    _classCallCheck$1(this, DateFilter);
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "dateRange", _descriptor$9, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "sortDir", _descriptor2$7, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "title", _descriptor3$6, _assertThisInitialized$1(_this));

    return _this;
  }

  _createClass$1(DateFilter, [{
    key: "sortDirChanged",
    value: function sortDirChanged(sortDir) {
      return sortDir;
    }
  }, {
    key: "dateRangeChanged",
    value: function dateRangeChanged(dateRange) {
      return dateRange;
    }
  }]);

  return DateFilter;
}(Vue), (_descriptor$9 = _applyDecoratedDescriptor(_class2$9.prototype, "dateRange", [_dec2$9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2$9.prototype, "sortDirChanged", [_dec5$6], Object.getOwnPropertyDescriptor(_class2$9.prototype, "sortDirChanged"), _class2$9.prototype), _applyDecoratedDescriptor(_class2$9.prototype, "dateRangeChanged", [_dec6$4], Object.getOwnPropertyDescriptor(_class2$9.prototype, "dateRangeChanged"), _class2$9.prototype)), _class2$9)) || _class$b);var _hoisted_1$a = {
...
var _hoisted_5$6 = /*#__PURE__*/vue.createVNode("option", {
  value: "DESC"
}, "Newest-Oldest", -1);

var _hoisted_6$6 = /*#__PURE__*/vue.createVNode("option", {
  value: "ASC"
}, "Oldest-Newest", -1);
...
function render$h(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("div", _hoisted_1$a, [vue.createVNode("div", _hoisted_2$9, [vue.createVNode("h1", _hoisted_3$8, vue.toDisplayString(_ctx.title), 1)]), vue.createVNode("div", _hoisted_4$7, [vue.createVNode("select", {
    onChange: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.sortDirChanged($event.target.value);
    }),
    class: "block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
  }, [_hoisted_5$6, _hoisted_6$6], 32), vue.createVNode(_component_DateRangePicker, {
    modelValue: _ctx.dateRange,
    "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
      return _ctx.dateRangeChanged($event);
    }),
    class: "ml-3"
  }, null, 8, ["modelValue"])])]);
}DateFilter.render = render$h;var _dec$a, _dec2$8, _dec3$8, _class$a, _class2$8, _descriptor$8;
var Paginator = (_dec$a = Options({
  name: "Paginator"
}), _dec2$8 = Prop({
  type: Object,
  required: true
}), _dec3$8 = Emit("update:modelValue"), _dec$a(_class$a = (_class2$8 = /*#__PURE__*/function (_Vue) {
  ...
  _createClass$1(Paginator, [{
    ...
    key: "changePerPage",
    value: function changePerPage(parent, perPage) {
      parent.blur();
    ...
    key: "endingItem",
    get: function get() {
      var end = this.modelValue.page * this.modelValue.perPage;
      return end > this.modelValue.totalItems ? this.modelValue.totalItems : end;
    }
  }, {
    key: "pageShortcuts",
    get: function get() {
      var shortcuts = []; // If total pages is less than or equal to 4, just return 1, 2, 3, 4

      if (this.modelValue.totalPages <= 4) {
        for (var i = 0; i < this.modelValue.totalPages; i++) {
          shortcuts.push(i + 1);
        }
      ...
      var pagesLeft = this.modelValue.totalPages - this.modelValue.page;

      if (pagesLeft >= 3) {
        for (var _i = 0; _i < 4; _i++) {
          shortcuts.push(this.modelValue.page + _i);
        }
      ...
      for (var _i2 = 0; _i2 < 4; _i2++) {
        shortcuts.unshift(this.modelValue.totalPages - _i2);
      }
    ...
    key: "startingItem",
    get: function get() {
      var start = this.modelValue.page * this.modelValue.perPage - this.modelValue.perPage + 1;
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2$8.prototype, "updateModelValue", [_dec3$8], Object.getOwnPropertyDescriptor(_class2$8.prototype, "updateModelValue"), _class2$8.prototype)), _class2$8)) || _class$a);var _hoisted_1$9 = {
...
var _hoisted_3$7 = /*#__PURE__*/vue.createVNode("svg", {
  class: "mr-3 h-5 w-5",
  fill: "currentColor",
  viewBox: "0 0 20 20"
...
var _hoisted_4$6 = /*#__PURE__*/vue.createTextVNode(" Previous ");
...
var _hoisted_7$5 = /*#__PURE__*/vue.createTextVNode(" Next ");

var _hoisted_8$4 = /*#__PURE__*/vue.createVNode("svg", {
  class: "ml-3 h-5 w-5",
  fill: "currentColor",
  viewBox: "0 0 20 20"
}, [/*#__PURE__*/vue.createVNode("path", {
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("div", _hoisted_1$9, [vue.createVNode("div", _hoisted_2$8, [vue.createVNode("a", {
    href: "#",
  ...
  }, [_hoisted_3$7, _hoisted_4$6], 2)]), vue.createVNode("div", _hoisted_5$5, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.pageShortcuts, function (i) {
    return vue.openBlock(), vue.createBlock("a", {
      ...
      onClick: vue.withModifiers(function ($event) {
        return _ctx.changePage(i);
      }, ["prevent"])
    }, null, 10, ["textContent", "onClick"]);
  }), 128))]), vue.createVNode("div", _hoisted_6$5, [vue.createVNode("a", {
    href: "#",
...
}Paginator.render = render$g;var _dec$9, _dec2$7, _dec3$7, _dec4$7, _dec5$5, _dec6$3, _dec7$1, _dec8$1, _dec9, _class$9, _class2$7, _descriptor$7, _descriptor2$6, _descriptor3$5, _descriptor4$5;
var DetailList = (_dec$9 = Options({
  components: {
  ...
  type: String,
  required: true
}), _dec6$3 = Watch("sortDir"), _dec7$1 = Watch("dateRange"), _dec8$1 = Watch("refreshTrigger"), _dec9 = Watch("reloadTrigger"), _dec$9(_class$9 = (_class2$7 = /*#__PURE__*/function (_Vue) {
  ...
  function DetailList() {
    ...
    _classCallCheck$1(this, DetailList);
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "refreshTrigger", _descriptor$7, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "reloadTrigger", _descriptor2$6, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "title", _descriptor3$5, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "url", _descriptor4$5, _assertThisInitialized$1(_this));

    _defineProperty$1(_assertThisInitialized$1(_this), "dateRange", {
      minDate: 0,
      maxDate: 0
    });

    _defineProperty$1(_assertThisInitialized$1(_this), "hasContent", true);

    _defineProperty$1(_assertThisInitialized$1(_this), "items", []);

    _defineProperty$1(_assertThisInitialized$1(_this), "pagination", {
      page: 1,
      perPage: 10,
      totalItems: 0,
      totalPages: 0
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "sortDir", "DESC");

    return _this;
  }

  _createClass$1(DetailList, [{
    key: "onSortDir",
    value: function onSortDir() {
    ...
    key: "loadAndRender",
    value: function loadAndRender(checkForContent) {
      var _this2 = this;
      ...
      BaseAPI.get(this.url, {}, Object.assign(params, this.dateRange)).then(function (success) {
        _this2.pagination = {
        ...
        _this2.items = success.data.items;
        if (checkForContent) _this2.hasContent = _this2.items.length != 0;
      }, function () {
  ...
  return DetailList;
}(Vue), (_descriptor$7 = _applyDecoratedDescriptor(_class2$7.prototype, "refreshTrigger", [_dec2$7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
function render$f(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("div", null, [vue.createVNode(_component_DateFilter, {
    "date-range": _ctx.dateRange,
    "sort-dir": _ctx.sortDir,
    title: _ctx.title,
    onSortDirChanged: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.sortDir = $event;
    }),
    onDateRangeChanged: _cache[2] || (_cache[2] = function ($event) {
      return _ctx.dateRange = $event;
    })
  }, null, 8, ["date-range", "sort-dir", "title"]), _ctx.hasContent ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$8, [vue.createVNode("ul", null, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.items, function (item, idx) {
    ...
    key: 1
  }), _ctx.hasContent ? (vue.openBlock(), vue.createBlock(_component_Paginator, {
    key: 2,
    modelValue: _ctx.pagination,
    "onUpdate:modelValue": [_cache[3] || (_cache[3] = function ($event) {
      return _ctx.pagination = $event;
    }), _cache[4] || (_cache[4] = function ($event) {
      return _ctx.loadAndRender(false);
    })]
  }, null, 8, ["modelValue"])) : vue.createCommentVNode("", true)]);
}DetailList.render = render$f;var _dec$8, _class$8;
var Flash = (_dec$8 = Options({
  name: "Flash"
}), _dec$8(_class$8 = /*#__PURE__*/function (_Vue) {
  ...
  function Flash() {
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "flashes", []);

    _defineProperty$1(_assertThisInitialized$1(_this), "flashTypeBorderClass", {
  ...
  _createClass$1(Flash, [{
    key: "mounted",
    value: function mounted() {
      var _this2 = this;

      window.VueBus.on("Flash-show-message", function (flash) {
        _this2.renderFlash(flash);
      });
      window.VueBus.on("Flash-show-generic-error", function (email) {
        _this2.renderGenericError(email);
      });

      if (window.Flashes) {
        var _iterator = _createForOfIteratorHelper(window.Flashes),
            _step;

        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var flash = _step.value;
            var values = flash.message.split(": ");
            this.renderFlash({
              type: values[0],
              message: values[1]
            });
    ...
    key: "remove",
    value: function remove(flash) {
      var index = 0;

      var _iterator2 = _createForOfIteratorHelper(this.flashes),
          _step2;
    ...
    key: "renderFlash",
    value: function renderFlash(flash) {
      ...
      setTimeout(function (flashes) {
        flashes.pop();
      }, 10000, this.flashes);
    }
  }, {
    key: "renderGenericError",
    value: function renderGenericError(email) {
      this.renderFlash({
        type: "error",
        message: "Whoops! Something went wrong, please reach out to " + "<a class=\"underline text-xy-blue\" href=\"mailto:".concat(email, "\">").concat(email, "</a>") + " if the issue persists."
      });
    }
  }]);

  return Flash;
}(Vue)) || _class$8);var _hoisted_1$7 = {
...
var _hoisted_7$4 = /*#__PURE__*/vue.createVNode("svg", {
  class: "h-5 w-5",
  viewBox: "0 0 20 20",
  fill: "currentColor"
}, [/*#__PURE__*/vue.createVNode("path", {
...
function render$e(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("div", _hoisted_1$7, [vue.createVNode(vue.TransitionGroup, {
    tag: "div",
    ...
    default: vue.withCtx(function () {
      return [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.flashes, function (flash, idx) {
        return vue.openBlock(), vue.createBlock("div", {
          key: flash.message,
          class: ["bg-white shadow-lg rounded-lg pointer-events-auto border-t-4 transform", [{
            'mt-2': idx > 0
          }, _ctx.flashTypeBorderClass[flash.type]]]
        }, [vue.createVNode("div", _hoisted_2$7, [vue.createVNode("div", _hoisted_3$6, [vue.createVNode("div", _hoisted_4$5, [vue.createVNode("div", _hoisted_5$4, [vue.createVNode("p", {
          class: "w-0 flex-1 text-sm leading-5 font-medium text-gray-900",
          innerHTML: flash.message
        }, null, 8, ["innerHTML"])]), vue.createVNode("div", _hoisted_6$4, [vue.createVNode("button", {
          onClick: function onClick($event) {
            return _ctx.remove(flash);
          },
...
}Flash.render = render$e;function render$d(_ctx, _cache) {
  return (vue.openBlock(), vue.createBlock("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    fill: "none",
    viewBox: "0 0 24 24",
...
var Modal = (_dec$7 = Options({
  ...
  type: String,
  required: false
}), _dec7 = Emit(), _dec8 = Emit("update:modelValue"), _dec$7(_class$7 = (_class2$6 = /*#__PURE__*/function (_Vue) {
  ...
  function Modal() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "destructive", _descriptor$6, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "disabled", _descriptor2$5, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "modelValue", _descriptor3$4, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "submitText", _descriptor4$4, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "title", _descriptor5$2, _assertThisInitialized$1(_this));
  ...
  return Modal;
}(Vue), (_descriptor$6 = _applyDecoratedDescriptor(_class2$6.prototype, "destructive", [_dec2$6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2$6.prototype, "submit", [_dec7], Object.getOwnPropertyDescriptor(_class2$6.prototype, "submit"), _class2$6.prototype), _applyDecoratedDescriptor(_class2$6.prototype, "updateModelValue", [_dec8], Object.getOwnPropertyDescriptor(_class2$6.prototype, "updateModelValue"), _class2$6.prototype)), _class2$6)) || _class$7);var _hoisted_1$6 = {
  class: "flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0"
};

var _hoisted_2$6 = /*#__PURE__*/vue.createVNode("span", {
    ...
    default: vue.withCtx(function () {
      return [vue.createVNode(_component_Dialog, {
        ...
        onClose: _cache[4] || (_cache[4] = function ($event) {
          return _ctx.updateModelValue(false);
        }),
        open: _ctx.modelValue
      }, {
        default: vue.withCtx(function () {
          return [vue.createVNode("div", _hoisted_1$6, [vue.createVNode(_component_TransitionChild, {
            as: "template",
            ...
            _: 1
          }), _hoisted_2$6, vue.createVNode(_component_TransitionChild, {
            as: "template",
            enter: "ease-out duration-300",
            ...
            default: vue.withCtx(function () {
              return [vue.createVNode("div", _hoisted_3$5, [vue.createVNode("div", _hoisted_4$4, [vue.createVNode("button", {
                type: "button",
                class: "bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500",
                onClick: _cache[1] || (_cache[1] = function ($event) {
                  return _ctx.updateModelValue(false);
                })
              }, [_hoisted_5$3, vue.createVNode(_component_XIcon, {
                class: "h-6 w-6",
                "aria-hidden": "true"
              })])]), vue.createVNode("div", _hoisted_6$3, [vue.createVNode("div", _hoisted_7$3, [vue.createVNode(_component_DialogTitle, {
                as: "h3",
                class: "text-center text-lg leading-6 font-medium text-gray-900",
                textContent: vue.toDisplayString(_ctx.title)
              }, null, 8, ["textContent"]), vue.createVNode("div", _hoisted_8$3, [vue.renderSlot(_ctx.$slots, "default")])])]), _ctx.submitText ? (vue.openBlock(), vue.createBlock("div", _hoisted_9$3, [vue.createVNode("button", {
                type: "button",
                class: ["xy-btn w-full sm:ml-3 sm:w-auto sm:text-sm", [_ctx.destructive ? 'xy-btn-red' : 'xy-btn']],
                onClick: _cache[2] || (_cache[2] = function ($event) {
                  return _ctx.submit();
                }),
                textContent: vue.toDisplayString(_ctx.submitText),
                disabled: _ctx.disabled
              }, null, 10, ["textContent", "disabled"]), vue.createVNode("button", {
                type: "button",
                ...
                ref: "cancelButtonRef"
              }, " Cancel ", 512)])) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, "buttons")])];
            }),
            _: 3
          })])];
        }),
...
}Modal.render = render$7;var _dec$6, _class$6;
var Spinner = (_dec$6 = Options({
  name: "Spinner"
}), _dec$6(_class$6 = /*#__PURE__*/function (_Vue) {
  ...
  function Spinner() {
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "idx", 0);

    _defineProperty$1(_assertThisInitialized$1(_this), "loading", false);

    _defineProperty$1(_assertThisInitialized$1(_this), "maxIdx", 0);

    _defineProperty$1(_assertThisInitialized$1(_this), "messages", []);

    _defineProperty$1(_assertThisInitialized$1(_this), "msg", "");

    _defineProperty$1(_assertThisInitialized$1(_this), "showMsg", false);
  ...
  _createClass$1(Spinner, [{
    ...
    value: function mounted() {
      ...
      window.VueBus.on("Spinner-show", function (messages) {
        if (messages) {
          _this2.messages = messages;
          _this2.maxIdx = _this2.messages.length - 1;
          _this2.msg = _this2.messages[_this2.idx];
          _this2.showMsg = true;
        }

        _this2.loading = true;
      });
      window.VueBus.on("Spinner-hide", function () {
        _this2.idx = 0;
        _this2.maxIdx = 0;
        _this2.messages = [];
        _this2.msg = "";
...
var _hoisted_2$5 = /*#__PURE__*/vue.createVNode("div", {
...
}, [/*#__PURE__*/vue.createVNode("title", null, "Group 6 Copy 3"), /*#__PURE__*/vue.createVNode("defs", null, [/*#__PURE__*/vue.createVNode("polygon", {
  id: "path-1",
  ...
  xmlns: "http://www.w3.org/2000/svg",
  "xmlns:xlink": "http://www.w3.org/1999/xlink"
}, [/*#__PURE__*/vue.createVNode("title", null, "Group 3 Copy"), /*#__PURE__*/vue.createVNode("g", {
  id: "Page-1",
  stroke: "none",
  "stroke-width": "1",
  fill: "none",
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.loading ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$5, [vue.createVNode("div", null, [_hoisted_2$5, vue.withDirectives(vue.createVNode("div", null, [vue.createVNode(vue.Transition, {
    appear: "",
    ...
    default: vue.withCtx(function () {
      ...
      }, vue.toDisplayString(_ctx.msg), 513), [[vue.vShow, _ctx.showMsg]])];
    }),
    _: 1
  }, 8, ["onAfterEnter", "onAfterLeave"])], 512), [[vue.vShow, _ctx.messages]])])])) : vue.createCommentVNode("", true);
}Spinner.render = render$6;var _dec$5, _dec2$5, _dec3$5, _dec4$5, _dec5$3, _class$5, _class2$5, _descriptor$5, _descriptor2$4, _descriptor3$3, _descriptor4$3;
var SidebarLayout = (_dec$5 = Options({
  components: {
    Flash: Flash,
    Spinner: Spinner,
    Dialog: Dialog,
  ...
  type: Array,
  required: true
}), _dec$5(_class$5 = (_class2$5 = /*#__PURE__*/function (_Vue) {
  ...
  function SidebarLayout() {
    ...
    _classCallCheck$1(this, SidebarLayout);
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "activeURL", _descriptor$5, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "iconURL", _descriptor2$4, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "navigation", _descriptor3$3, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "userNavigation", _descriptor4$3, _assertThisInitialized$1(_this));

    _defineProperty$1(_assertThisInitialized$1(_this), "sidebarOpen", false);

    return _this;
  }

  _createClass$1(SidebarLayout, [{
    key: "isActive",
...
}(Vue), (_descriptor$5 = _applyDecoratedDescriptor(_class2$5.prototype, "activeURL", [_dec2$5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2$5)) || _class$5);var _hoisted_1$4 = {
...
var _hoisted_4$3 = /*#__PURE__*/vue.createVNode("span", {
  class: "sr-only"
}, "Close sidebar", -1);
...
var _hoisted_8$2 = /*#__PURE__*/vue.createVNode("div", {
...
var _hoisted_17$1 = /*#__PURE__*/vue.createVNode("span", {
  class: "sr-only"
}, "Open sidebar", -1);
...
var _hoisted_22 = /*#__PURE__*/vue.createVNode("span", {
  class: "sr-only"
}, "Open user menu", -1);
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_MenuAlt2Icon = vue.resolveComponent("MenuAlt2Icon");

  var _component_CogIcon = vue.resolveComponent("CogIcon");
  ...
  var _component_Flash = vue.resolveComponent("Flash");

  var _component_Spinner = vue.resolveComponent("Spinner");

  return vue.openBlock(), vue.createBlock(vue.Fragment, null, [vue.createVNode("div", _hoisted_1$4, [vue.createVNode(_component_TransitionRoot, {
    as: "template",
    ...
    default: vue.withCtx(function () {
      return [vue.createVNode(_component_Dialog, {
        ...
        default: vue.withCtx(function () {
          return [vue.createVNode(_component_TransitionChild, {
            as: "template",
            ...
            default: vue.withCtx(function () {
              return [vue.createVNode("div", _hoisted_2$4, [vue.createVNode(_component_TransitionChild, {
                as: "template",
                ...
                default: vue.withCtx(function () {
                  return [vue.createVNode("div", _hoisted_3$4, [vue.createVNode("button", {
                    class: "ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white",
                    onClick: _cache[1] || (_cache[1] = function ($event) {
                      return _ctx.sidebarOpen = false;
                    })
                  }, [_hoisted_4$3, vue.createVNode(_component_XIcon, {
                    class: "h-6 w-6 text-white",
                    "aria-hidden": "true"
                  })])])];
                }),
                _: 1
              }), vue.createVNode("div", _hoisted_5$2, [vue.createVNode("img", {
                class: "h-8 w-auto",
                src: _ctx.iconURL,
                alt: "Workflow"
              }, null, 8, ["src"])]), vue.createVNode("div", _hoisted_6$2, [vue.createVNode("nav", _hoisted_7$2, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.navigation, function (item) {
                return vue.openBlock(), vue.createBlock("a", {
                  key: item.name,
                  href: item.url,
                  ...
                  "aria-hidden": "true"
                }, null, 8, ["class"])), vue.createTextVNode(" " + vue.toDisplayString(item.name), 1)], 10, ["href"]);
              }), 128))])])])];
            }),
            _: 1
          }), _hoisted_8$2];
    ...
    _: 1
  }, 8, ["show"]), vue.createVNode("div", _hoisted_9$2, [vue.createVNode("div", _hoisted_10$2, [vue.createVNode("div", _hoisted_11$2, [vue.createVNode("div", _hoisted_12$2, [vue.createVNode("img", {
    class: "h-8 w-auto",
    src: _ctx.iconURL,
    alt: "Workflow"
  }, null, 8, ["src"])]), vue.createVNode("div", _hoisted_13$2, [vue.createVNode("nav", _hoisted_14$2, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.navigation, function (item) {
    return vue.openBlock(), vue.createBlock("a", {
      key: item.name,
      href: item.url,
  ...
  }), 128))])])])])]), vue.createVNode("div", _hoisted_15$2, [vue.createVNode("div", _hoisted_16$1, [vue.createVNode("button", {
  ...
  }, [_hoisted_17$1, vue.createVNode(_component_MenuAlt2Icon, {
    class: "h-6 w-6",
    "aria-hidden": "true"
  })]), vue.createVNode("div", _hoisted_18$1, [vue.createVNode("div", _hoisted_19, [vue.createVNode("h1", _hoisted_20, [vue.renderSlot(_ctx.$slots, "header")])]), vue.createVNode("div", _hoisted_21, [vue.createVNode(_component_Menu, {
    as: "div",
    class: "ml-3 relative"
  }, {
    default: vue.withCtx(function () {
      return [vue.createVNode("div", null, [vue.createVNode(_component_MenuButton, {
        ...
        default: vue.withCtx(function () {
          return [_hoisted_22, vue.createVNode(_component_CogIcon, {
            class: "h-8 w-8",
            fill: "currentColor"
          })];
        }),
        ...
        default: vue.withCtx(function () {
          return [vue.createVNode(_component_MenuItems, {
            ...
            default: vue.withCtx(function () {
              return [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.userNavigation, function (item) {
    ...
    _: 1
  })])])]), vue.createVNode("main", _hoisted_23, [vue.createVNode("div", _hoisted_24, [vue.createVNode("div", _hoisted_25, [vue.renderSlot(_ctx.$slots, "default")])])])])]), vue.createVNode(_component_Flash), vue.createVNode(_component_Spinner)], 64);
}SidebarLayout.render = render$5;var _dec$4, _dec2$4, _dec3$4, _dec4$4, _dec5$2, _dec6$1, _class$4, _class2$4, _descriptor$4, _descriptor2$3, _descriptor3$2, _descriptor4$2, _descriptor5$1;
var StackedLayout = (_dec$4 = Options({
  components: {
    Flash: Flash,
    Spinner: Spinner,
  ...
  type: Array,
  required: true
}), _dec$4(_class$4 = (_class2$4 = /*#__PURE__*/function (_Vue) {
  ...
  function StackedLayout() {
    ...
    _classCallCheck$1(this, StackedLayout);
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "activeURL", _descriptor$4, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "currentUser", _descriptor2$3, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "iconURL", _descriptor3$2, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "navigation", _descriptor4$2, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "userNavigation", _descriptor5$1, _assertThisInitialized$1(_this));
...
}(Vue), (_descriptor$4 = _applyDecoratedDescriptor(_class2$4.prototype, "activeURL", [_dec2$4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2$4)) || _class$4);var _hoisted_1$3 = {
...
var _hoisted_10$1 = /*#__PURE__*/vue.createVNode("span", {
  class: "sr-only"
}, "Open main menu", -1);
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_MenuIcon = vue.resolveComponent("MenuIcon");

  var _component_XIcon = vue.resolveComponent("XIcon");

  var _component_DisclosureButton = vue.resolveComponent("DisclosureButton");

  var _component_DisclosurePanel = vue.resolveComponent("DisclosurePanel");

  var _component_Disclosure = vue.resolveComponent("Disclosure");

  var _component_Flash = vue.resolveComponent("Flash");

  var _component_Spinner = vue.resolveComponent("Spinner");

  return vue.openBlock(), vue.createBlock(vue.Fragment, null, [vue.createVNode("div", _hoisted_1$3, [vue.createVNode(_component_Disclosure, {
    as: "nav",
    class: "bg-white shadow-sm"
  }, {
    default: vue.withCtx(function (_ref) {
      var open = _ref.open;
      return [vue.createVNode("div", _hoisted_2$3, [vue.createVNode("div", _hoisted_3$3, [vue.createVNode("div", _hoisted_4$2, [vue.createVNode("div", _hoisted_5$1, [vue.createVNode("img", {
        class: "block h-8 w-auto",
        src: _ctx.iconURL,
        alt: "XY Trees"
      }, null, 8, ["src"])]), vue.createVNode("div", _hoisted_6$1, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.navigation, function (item) {
        return vue.openBlock(), vue.createBlock("a", {
          key: item.name,
          href: item.url,
      ...
      }), 128))])]), vue.createVNode("div", _hoisted_7$1, [vue.createVNode(_component_Menu, {
        as: "div",
        class: "ml-3 relative"
      }, {
        default: vue.withCtx(function () {
          return [vue.createVNode("div", null, [vue.createVNode(_component_MenuButton, {
            ...
            default: vue.withCtx(function () {
              return [_hoisted_8$1, vue.createVNode(_component_UserCircleIcon, {
        ...
        _: 1
      })]), vue.createVNode("div", _hoisted_9$1, [vue.createVNode(_component_DisclosureButton, {
        ...
        default: vue.withCtx(function () {
          return [_hoisted_10$1, !open ? (vue.openBlock(), vue.createBlock(_component_MenuIcon, {
            key: 0,
            class: "block h-6 w-6",
            "aria-hidden": "true"
        ...
        _: 2
      }, 1024)])])]), vue.createVNode(_component_DisclosurePanel, {
        class: "sm:hidden"
      }, {
        default: vue.withCtx(function () {
          return [vue.createVNode("div", _hoisted_11$1, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.navigation, function (item) {
            return vue.openBlock(), vue.createBlock("a", {
              key: item.name,
              href: item.url,
          ...
          })]), vue.createVNode("div", _hoisted_15$1, [vue.createVNode("div", {
            class: "text-base font-medium text-gray-800",
            textContent: vue.toDisplayString(_ctx.currentUser.name)
          }, null, 8, ["textContent"]), vue.createVNode("div", {
            class: "text-sm font-medium text-gray-500",
            textContent: vue.toDisplayString(_ctx.currentUser.email)
          }, null, 8, ["textContent"])])]), vue.createVNode("div", _hoisted_16, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.userNavigation, function (item) {
            return vue.openBlock(), vue.createBlock("a", {
              key: item.name,
              href: item.url,
    ...
    _: 1
  }), vue.renderSlot(_ctx.$slots, "header"), vue.createVNode("main", null, [vue.createVNode("div", _hoisted_17, [vue.createVNode("div", _hoisted_18, [vue.renderSlot(_ctx.$slots, "default")])])])]), vue.createVNode(_component_Flash), vue.createVNode(_component_Spinner)], 64);
}StackedLayout.render = render$4;var _dec$3, _dec2$3, _dec3$3, _dec4$3, _class$3, _class2$3, _descriptor$3;
var Table = (_dec$3 = Options({
  components: {
    Paginator: Paginator
  },
  name: "Table"
  ...
  type: Object,
  required: true
}), _dec3$3 = Watch("tableData.refreshTrigger"), _dec4$3 = Watch("tableData.reloadTrigger"), _dec$3(_class$3 = (_class2$3 = /*#__PURE__*/function (_Vue) {
  ...
  function Table() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "tableData", _descriptor$3, _assertThisInitialized$1(_this));

    _defineProperty$1(_assertThisInitialized$1(_this), "currentSort", "");

    _defineProperty$1(_assertThisInitialized$1(_this), "currentSortDirection", "");
    ...
    _defineProperty$1(_assertThisInitialized$1(_this), "query", "");
  ...
  _createClass$1(Table, [{
    ...
    key: "cellValue",
    value: function cellValue(item, col) {
      if (col.key) {
        return item[col.key];
      }
    ...
    key: "handleSort",
    value: function handleSort(selectedSort) {
    ...
    value: function loadAndRender(checkForContent) {
      ...
      BaseAPI.get(this.tableData.url, {}, params).then(function (success) {
        window.clearTimeout(wait);
  ...
  return Table;
}(Vue), (_descriptor$3 = _applyDecoratedDescriptor(_class2$3.prototype, "tableData", [_dec2$3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var _hoisted_2$2 = /*#__PURE__*/vue.createVNode("label", {
  for: "search",
  class: "sr-only"
}, "Search", -1);
...
var _hoisted_11 = /*#__PURE__*/vue.createVNode("path", {
  "fill-rule": "evenodd",
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("div", null, [_ctx.tableData.search ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$2, [_hoisted_2$2, vue.createVNode("div", _hoisted_3$2, [_hoisted_4$1, vue.withDirectives(vue.createVNode("input", {
    class: "pl-10",
    type: "search",
    ...
    onChange: _cache[2] || (_cache[2] = function ($event) {
      return _ctx.reloadTable();
    })
  }, null, 544), [[vue.vModelText, _ctx.query, void 0, {
    trim: true
  }]])])])) : vue.createCommentVNode("", true), vue.createVNode("div", _hoisted_5, [vue.createVNode("table", _hoisted_6, [vue.createVNode("thead", null, [vue.createVNode("tr", null, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.tableData.columns, function (col, idx) {
    return vue.openBlock(), vue.createBlock("th", {
      ...
      key: idx
    }, [!!col.display.length ? (vue.openBlock(), vue.createBlock("span", _hoisted_7, vue.toDisplayString(col.display), 1)) : vue.createCommentVNode("", true), col.sort ? (vue.openBlock(), vue.createBlock("span", {
      key: 1,
      class: "cursor-pointer",
      onClick: vue.withModifiers(function ($event) {
        return _ctx.handleSort(col.sort);
      }, ["prevent"])
    }, [_ctx.currentSort !== col.sort ? (vue.openBlock(), vue.createBlock("svg", _hoisted_8, [_hoisted_9])) : _ctx.currentSortDirection == 'desc' ? (vue.openBlock(), vue.createBlock("svg", _hoisted_10, [_hoisted_11])) : (vue.openBlock(), vue.createBlock("svg", _hoisted_12, [_hoisted_13]))], 8, ["onClick"])) : vue.createCommentVNode("", true)]);
  }), 128))])]), vue.createVNode("tbody", _hoisted_14, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.items, function (item, rowIdx) {
    return vue.openBlock(), vue.createBlock("tr", {
      ...
      return vue.openBlock(), vue.createBlock("td", {
        ...
        attribute: col.key,
        items: col.items
      }, null, 8, ["props-data", "current-user", "attribute", "items"])) : (vue.openBlock(), vue.createBlock("div", {
        key: 1,
        textContent: vue.toDisplayString(_ctx.cellValue(item, col))
      }, null, 8, ["textContent"]))], 2);
    }), 128))]);
  }), 128)), _ctx.items.length == 0 ? (vue.openBlock(), vue.createBlock("tr", _hoisted_15, [vue.createVNode("td", {
...
}Table.render = render$3;var _dec$2, _dec2$2, _dec3$2, _dec4$2, _class$2, _class2$2, _descriptor$2, _descriptor2$2;
var Tabs = (_dec$2 = Options({
  name: "Tabs"
}), _dec2$2 = Prop({
  type: Array,
  required: true
  ...
  type: String,
  required: true
}), _dec4$2 = Emit("update:modelValue"), _dec$2(_class$2 = (_class2$2 = /*#__PURE__*/function (_Vue) {
  ...
  function Tabs() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "tabs", _descriptor$2, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "modelValue", _descriptor2$2, _assertThisInitialized$1(_this));
  ...
  _createClass$1(Tabs, [{
    key: "updateModelValue",
    value: function updateModelValue(modelValue) {
      return modelValue;
    }
  }]);

  return Tabs;
}(Vue), (_descriptor$2 = _applyDecoratedDescriptor(_class2$2.prototype, "tabs", [_dec2$2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2$2.prototype, "updateModelValue", [_dec4$2], Object.getOwnPropertyDescriptor(_class2$2.prototype, "updateModelValue"), _class2$2.prototype)), _class2$2)) || _class$2);var _hoisted_1$1 = {
  class: "sm:hidden mb-4"
};

var _hoisted_2$1 = /*#__PURE__*/vue.createVNode("label", {
  for: "tabs",
  class: "sr-only"
}, "Select a tab", -1);
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock("div", null, [vue.createVNode("div", _hoisted_1$1, [_hoisted_2$1, vue.createVNode(_component_Select, {
    name: "tabs",
    ...
    options: _ctx.tabs
  }, null, 8, ["modelValue", "options"])]), vue.createVNode("div", _hoisted_3$1, [vue.createVNode("nav", _hoisted_4, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.tabs, function (tab, idx) {
    return vue.openBlock(), vue.createBlock("a", {
      href: "#",
      ...
      key: idx,
      textContent: vue.toDisplayString(tab.label),
      onClick: vue.withModifiers(function ($event) {
        return _ctx.updateModelValue(tab.value);
      }, ["prevent"])
    }, null, 10, ["textContent", "onClick"]);
  }), 128))])])]);
}Tabs.render = render$2;var _dec$1, _dec2$1, _dec3$1, _dec4$1, _dec5$1, _dec6, _class$1, _class2$1, _descriptor$1, _descriptor2$1, _descriptor3$1, _descriptor4$1, _descriptor5;
var Checkbox = (_dec$1 = Options({
  name: "Checkbox"
}), _dec2$1 = Prop({
  type: Boolean,
  required: false
  ...
  function Checkbox() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "disabled", _descriptor$1, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "emphasis", _descriptor2$1, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "label", _descriptor3$1, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "required", _descriptor4$1, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "modelValue", _descriptor5, _assertThisInitialized$1(_this));

    return _this;
  }

  return Checkbox;
}(Vue), (_descriptor$1 = _applyDecoratedDescriptor(_class2$1.prototype, "disabled", [_dec2$1], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2$1)) || _class$1);var _hoisted_1 = {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("div", _hoisted_1, [vue.createVNode("div", _hoisted_2, [vue.createVNode("input", {
    type: "checkbox",
  ...
  }, null, 40, ["checked", "disabled", "required"])]), vue.createVNode("div", _hoisted_3, [vue.createVNode("label", {
    class: ["text-gray-500", {
      'font-medium': _ctx.emphasis
    }],
    textContent: vue.toDisplayString(_ctx.label)
  }, null, 10, ["textContent"])])]);
}Checkbox.render = render$1;var _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4;
var Select = (_dec = Options({
  name: "Select"
}), _dec2 = Prop({
  type: String,
  required: false
  ...
  function Select() {
    ...
    _initializerDefineProperty(_assertThisInitialized$1(_this), "design", _descriptor, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "options", _descriptor2, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "placeholder", _descriptor3, _assertThisInitialized$1(_this));

    _initializerDefineProperty(_assertThisInitialized$1(_this), "modelValue", _descriptor4, _assertThisInitialized$1(_this));
  ...
  return Select;
}(Vue), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "design", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2)) || _class);function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock("select", {
    class: _ctx.classes,
    value: _ctx.modelValue,
    onChange: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.$emit('update:modelValue', $event.target.value);
    })
  }, [_ctx.placeholder ? (vue.openBlock(), vue.createBlock("option", {
    key: 0,
    value: "",
    disabled: "",
    selected: "",
    hidden: "",
    textContent: vue.toDisplayString(_ctx.placeholder)
  }, null, 8, ["textContent"])) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.options, function (option) {
...
}Select.render = render;// TODO: rearrange so that these are default installed by app.use(Trees);
var components$1=/*#__PURE__*/Object.freeze({__proto__:null,ActionsDropdown: ActionsDropdown,DateFilter: DateFilter,DetailList: DetailList,Flash: Flash,Modal: Modal,SidebarLayout: SidebarLayout,StackedLayout: StackedLayout,Paginator: Paginator,Spinner: Spinner,Table: Table,Tabs: Tabs,Checkbox: Checkbox,DateRangePicker: DateRangePicker,Select: Select});var install = function installTrees(app) {
...
var components=/*#__PURE__*/Object.freeze({__proto__:null,'default': install,BaseAPI: BaseAPI,ActionsDropdown: ActionsDropdown,DateFilter: DateFilter,DetailList: DetailList,Flash: Flash,Modal: Modal,SidebarLayout: SidebarLayout,StackedLayout: StackedLayout,Paginator: Paginator,Spinner: Spinner,Table: Table,Tabs: Tabs,Checkbox: Checkbox,DateRangePicker: DateRangePicker,Select: Select});// only expose one global var, with component exports exposed as properties of
